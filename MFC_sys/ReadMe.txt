...
MFC_sysDlg.h、MFC_sysDlg.cpp - 對話方塊
    這些檔案包含您的 CMFC_sysDlg 類別。這個類別會定義應用程式主對話方塊的行為。對話方塊的範本是在可於 Microsoft Visual C++ 編輯的 MFC_sys.rc 中。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 MFC_sys.pch 的先行編譯標頭 (PCH) 檔，以及名為 StdAfx.obj 的先行編譯型別檔。
